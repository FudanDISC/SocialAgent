...
- [9 Jan 2024]Tu et al.,CharacterEval: A Chinese Benchmark for Role-Playing Conversational Agent Evaluation
- [28 Nov 2023]Zhou et al.,CharacterGLM: Customizing Chinese Conversational AI Characters with Large Language Models
- [14 Dec 2023]Shao et al.,Character-LLM: A Trainable Agent for Role-Playing
- [8 Oct 2024]Yuan et al.,Evaluating Character Understanding of Large Language Models via Character Profiling from Fictional Works
- [15 Oct 2024]Ran et al.,Capturing Minds, Not Just Words: Enhancing Role-Playing Language Models with Personality-Indicative Data
- [7 Jun 2024]Wang et al.,InCharacter: Evaluating Personality Fidelity in Role-Playing Agents through Psychological Interviews
- [18 Jun 2024]Wang et al.,RoleLLM: Benchmarking, Eliciting, and Enhancing Role-Playing Abilities of Large Language Models
- [9 May 2023]Schwitzgebel et al.,Creating a Large Language Model of a Philosopher
- [18 Aug 2023]Li et al.,ChatHaruhi: Reviving Anime Character in Reality via Large Language Model
- [6 Aug 2023]Park et al.,Generative Agents: Interactive Simulacra of Human Behavior
...
- [15 Feb 2024]Weng et al.,ControlLM: Crafting Diverse Personalities for Language Models
- [24 Sep 2024]Ge et al.,Scaling Synthetic Data Creation with 1,000,000,000 Personas
- [25 Sep 2024]Abbasian et al.,Conversational Health Agents: A Personalized LLM-Powered Agent Framework
- [22 Oct 2023]Chawla et al.,Be Selfish, But Wisely: Investigating the Impact of Agent Personality in Mixed-Motive Human-Agent Interactions
- [8 Feb 2024]Lee et al.,Can Large Language Models Capture Public Opinion about Global Warming? An Empirical Assessment of Algorithmic Fidelity and Bias
- [16 Oct 2023]Shea et al.,Building Persona Consistent Dialogue Agents with Offline Reinforcement Learning
- [24 Aug 2024]Chen et al.,Put Your Money Where Your Mouth Is: Evaluating Strategic Planning and Execution of LLM Agents in an Auction Arena
- [30 Jul 2023]Pan et al.,Do LLMs Possess a Personality? Making the MBTI Test an Amazing Evaluation for Large Language Models
- [29 May 2023]Cheng et al.,Marked Personas: Using Natural Language Prompts to Measure Stereotypes in Language Models
- [24 May 2023]Song et al.,Have Large Language Models Developed a Personality?: Applicability of Self-Assessment Tests in Measuring Personality in LLMs
- [4 Oct 2024]Huang et al.,Emotionally Numb or Empathetic? Evaluating How LLMs Feel Using EmotionBench
- [28 Oct 2023]Xiang et al.,Language Models Meet World Models: Embodied Experiences Enhance Language Models
- [21 Sep 2023]Serapio-García et al.,Personality Traits in Large Language Models
- [29 Oct 2023]Jiang et al.,Evaluating and Inducing Personality in Pre-trained Language Models
- [11 Apr 2023]Deshpande et al.,Toxicity in ChatGPT: Analyzing Persona-assigned Language Models
- [28 Apr 2023]Xie et al.,The Wall Street Neophyte: A Zero-Shot Analysis of ChatGPT Over MultiModal Stock Movement Prediction Challenges
...
- [3 Oct 2023]Wu et al.,AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation
- [14 Aug 2023]Chan et al.,ChatEval: Towards Better LLM-based Evaluators through Multi-Agent Debate
- [18 Oct 2023]Xiong et al.,Examining Inter-Consistency of Large Language Models Collaboration: An In-depth Analysis via Debate
...
- [8 Nov 2023]Light et al.,AvalonBench: Evaluating LLMs Playing the Game of Avalon
- [13 Oct 2024]Lan et al.,LLM-Based Agent Society Investigation: Collaboration and Confrontation in Avalon Gameplay
- [20 Feb 2024]Xu et al.,Language Agents with Reinforcement Learning for Strategic Play in the Werewolf Game
- [29 Feb 2024]Wu et al.,Deciphering Digital Detectives: Understanding LLM Behaviors and Capabilities in Multi-Agent Mystery Games
- [29 Dec 2023]Shi et al.,Cooperation on the Fly: Exploring Language Agents for Ad Hoc Teamwork in the Avalon Game
- [29 Mar 2024]Wu et al.,Enhance Reasoning for Large Language Models in the Game Werewolf
- [29 Aug 2024]Du et al.,Helmsman of the Masses? Evaluate the Opinion Leadership of Large Language Models in the Werewolf Game
- [17 Jun 2024]Zhu et al.,PLAYER: Enhancing LLM-based Multi-Agent Communication and Interaction in Murder Mystery Games*
- [1 Jun 2023]Zhu et al.,Ghost in the Minecraft: Generally Capable Agents for Open-World Environments via Large Language Models with Text-based Knowledge and Memory
- [2 Jul 2024]Sreedhar et al.,Simulating Human Strategic Behavior: Comparing Single and Multi-agent LLMs
...
- [5 May 2024]Li et al.,Agent Hospital: A Simulacrum of Hospital with Evolvable Medical Agents
- [24 May 2024]Li et al.,CulturePark: Boosting Cross-cultural Understanding in Large Language Models
- [10 Nov 2023]Zheng et al.,ChatGPT Research Group for Optimizing the Crystallinity of MOFs and COFs
- [16 Nov 2023]Tang et al.,MedAgents: Large Language Models as Collaborators for Zero-shot Medical Reasoning
- [16 Feb 2024]Gao et al.,Reviewer2: Optimizing Review Generation Through Prompt Generation
- [20 Feb 2024]Jin et al.,What if LLMs Have Different World Views: Simulating Alien Civilizations with LLM-based Agents
- [11 Apr 2024]Baek et al.,ResearchAgent: Iterative Research Idea Generation over Scientific Literature with Large Language Models
- [11 Jun 2024]Yukhymenko et al.,A Synthetic Dataset for Personal Attribute Inference
...
- [10 Apr 2024]Yue et al.,MathVC: An LLM-Simulated Multi-Character Virtual Classroom for Mathematics Education
- [26 Jun 2024]Baker et al.,Simulating The U.S. Senate: An LLM-Driven Agent Approach to Modeling Legislative Behavior and Bipartisanship
- [23 Jul 2024][Sun et al.,*LawLuo: A Chinese Law Firm Co-run by LLM Agents*](LawLuo: A Chinese Law Firm Co-run by LLM Agents)
- [5 Sep 2024]Yu et al.,From MOOC to MAIC: Reshaping Online Teaching and Learning through LLM-driven Agents
- [31 Mar 2023]Li et al.,CAMEL: Communicative Agents for "Mind" Exploration of Large Language Model Society
- [27 May 2023]Lin et al.,SwiftSage: A Generative Agent with Fast and Slow Thinking for Complex Interactive Tasks
- [5 Jun 2023]Talebirad et al.,Multi-Agent Collaboration: Harnessing the Power of Intelligent LLM Agents
- [5 Jul 2023]Zhang et al.,Building Cooperative Embodied Agents Modularly with Large Language Models
- [10 Jul 2023]Zhao et al.,RoCo: Dialectic Multi-Robot Collaboration with Large Language Models
- [21 Aug 2023]Chen et al.,AgentVerse: Facilitating Multi-Agent Collaboration and Exploring Emergent Behaviors
- [27 Sep 2023]Chen et al.,Scalable Multi-Robot Collaboration with Large Language Models: Centralized or Decentralized Systems?
- [29 Sep 2023]Chen et al.,AutoAgents: A Framework for Automatic Agent Generation
- [16 Oct 2023]Xie et al.,OpenAgents: An Open Platform for Language Agents in the Wild
- [25 Jan 2024]Tan et al.,True Knowledge Comes from Practice: Aligning LLMs with Embodied Environments via Reinforcement Learning
...
- [8 May 2024]Noh et al.,LLMs with Personalities in Multi-issue Negotiation Games 
- [19 Feb 2024]Wu et al.,Shall We Team Up: Exploring Spontaneous Cooperation of Competing LLM Agents 
- [7 Feb 2024]Xie et al.,Can large language model agents simulate human trust behaviors? 
- [3 Jan 2024]Guo et al.,Economics Arena for Large Language Models 
...
- [16 Oct 2023]Li et al.,EconAgent: Large Language Model-Empowered Agents for Simulating Macroeconomic Activities
...
- [28 Feb 2024]Sun et al.,Random Silicon Sampling: Simulating Human Sub-Population Opinion Using a Large Language Model Based on Group-Level Demographic Information
- [6 May 2024]Chaudhary et al.,Large Language Models as Instruments of Power: New Regimes of Autonomous Manipulation and Control
...
- [25 Jun 2024]Chuang et al.,Beyond Demographics: Aligning Role-playing LLM-based Agents Using Human Belief Networks
- [13 Mar 2024]Ren et al.,Emergence of Social Norms in Generative Agent Societies: Principles and Architecture
- [3 Feb 2024]Yu et al.,Affordable Generative Agents
- [16 Nov 2023]Chuang et al.,The Wisdom of Partisan Crowds: Comparing Collective Intelligence in Humans and LLM-based Agents
- [16 Nov 2023]Chuang et al.,Simulating Opinion Dynamics with Networks of LLM-based Agents
- [8 Nov 2023]Jarrett et al.,Language Agents as Digital Representatives in Collective Decision-Making
- [3 Oct 2023]Kaiya et al.,Lyfe Agents: Generative agents for low-cost real-time social interactions
- [2 Oct 2023]Chuang et al.,ChoiceMates: Supporting Unfamiliar Online Decision-Making with Multi-Agent Conversational Interactions
- [3 Oct 2023]Zhang et al.,Exploring Collaboration Mechanisms for LLM Agents: A Social Psychology View
- [3 Oct 2023]Suzuki et al.,An evolutionary model of personality traits related to cooperative behavior using a large language model
- [7 Apr 2023]Park et al.,Generative Agents: Interactive Simulacra of Human Behavior
...
- [28 Sep 2024]Wang et al.,Decoding Echo Chambers: LLM-Powered Simulations Revealing Polarization in Social Networks
- [7 Jul 2024]Xu et al.,MINDECHO: Role-Playing Language Agents for Key Opinion Leaders
- [5 May 2024]Cai et al.,Language Evolution for Evading Social Media Regulation via LLM-based Multi-agent Simulation
- [1 Aug 2024]Rossetti et al.,Y Social: an LLM-powered Social Media Digital Twin
- [27 Feb 2024]Touzel et al.,A Simulation System Towards Solving Societal-Scale Manipulation
- [26 Feb 2024]Mou et al.,Unveiling the Truth and Facilitating Change: Towards Agent-based Large-scale Social Movement Simulation
- [14 Mar 2024]Liu et al.,From Skepticism to Acceptance: Simulating the Attitude Dynamics Toward Fake News
- [27 Jul 2023]Gao et al.,S3: Social-network Simulation System with Large Language Model-Empowered Agents
- [5 Oct 2023]Tornberg et al.,Simulating Social Media Using Large Language Models to Evaluate Alternative News Feed Algorithms
...
- [31 Aug 2023]Huang et al.,Recommender AI Agent: Integrating Large Language Models for Interactive Recommendations
- [5 Jun 2023]Wang et al.,RecAgent: A Novel Simulation Paradigm for Recommender Systems
